...
void RocketLauncher::InitializeFuzzyModule()
{
  ...
  FzSet& Desirable = Desirability.AddTriangularSet("Desirable", 20, 50, 75);
  FzSet& Undesirable = Desirability.AddTriangularSet("Undesirable", 10, 20, 50);
  FzSet& Notdesirable = Desirability.AddLeftShoulderSet("Notdesirable", 0, 10, 20);//
  ...
  FzSet& Ammo_Few = AmmoStatus.AddTriangularSet("Ammo_Few", 0, 10, 20);//
  ...
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Okay), Notdesirable);//
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Few), Notdesirable);//
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Low), Notdesirable);//
  ...
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Few), Desirable);//
  ...
  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Few), Undesirable);//
  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Low), Notdesirable);//
}
