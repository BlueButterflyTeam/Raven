...
private:
  ...
  //-----------------------------
	...
	std::poisson_distribution<int>* m_pPoissonDistribution;
  //-----------------------------
...
public:
  ...
  //--------------------------------------------------------------
  std::default_random_engine*	const		GetRandomGenerator(){ return m_pRandomGenerator; }
  std::poisson_distribution<int>*	const	GetPoissonDistribution(){ return m_pPoissonDistribution; }

  inline double		GetPoissonDistributionSample(){
	  //const std::poisson_distribution<int>* PD = GetPoissonDistribution();
	  //return (double)(*PD)(*GetRandomGenerator());
	  return (double)(*m_pPoissonDistribution)((*m_pRandomGenerator));
  }

  inline void		SetPoissonDistributionMean(double mean){
	  std::poisson_distribution<int> dummy(mean);
	  m_pPoissonDistribution->param(dummy.param());
  }
  //--------------------------------------------------------------
