; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24213.1 
	...
	TITLE	E:\Documents\Cours\Git\Raven\Raven\armory\Projectile_Rocket.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG169141 DB	'Rocket_MaxForce', 00H
$SG169142 DB	'Rocket_Mass', 00H
$SG169143 DB	'Rocket_MaxSpeed', 00H
$SG169144 DB	'Rocket_Scale', 00H
	ORG $+3
$SG169145 DB	'Rocket_Damage', 00H
	ORG $+2
$SG169146 DB	'Rocket_BlastRadius', 00H
	ORG $+1
$SG169147 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	...
	ORG $+2
$SG169148 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
	DB	' ', 00H, '!', 00H, '=', 00H, ' ', 00H, 'V', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'o', 00H, 'r', 00H, '2', 00H, 'D', 00H, '(', 00H
	DB	')', 00H, 00H, 00H
	ORG $+2
$SG169162 DB	'Rocket_ExplosionDecayRate', 00H
	ORG $+2
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\git\raven\raven\armory\projectile_rocket.cpp
_TEXT	SEGMENT
tv203 = -44						; size = 8
$T1 = -36						; size = 16
$T2 = -20						; size = 16
...
; 32   :    assert (target != Vector2D());
	...
	push	32					; 00000020H
	push	OFFSET $SG169147
	push	OFFSET $SG169148
	call	__wassert
	add	esp, 12					; 0000000cH
$LN3@Rocket:
