; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24213.1 
	...
	TITLE	E:\Documents\Cours\Git\Raven\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG151264 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG151265 DB	'.', 00H, '.', 00H, '\', 00H, 'C', 00H, 'o', 00H, 'm', 00H
	...
	DB	'p', 00H, 00H, 00H
	ORG $+4
$SG151266 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\git\raven\common\game\basegameentity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG151264
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG151265
