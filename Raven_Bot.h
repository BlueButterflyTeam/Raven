...
private:
	...
	//--------------------
	//Skill level, proficiency at firearms(poisson distribution with mean = 50;(raven_game.cpp)
	double m_dSkillLevel;
	//--------------------
...
public:
  ...
  Raven_Bot(Raven_Game* world, Vector2D pos, double skill);
  virtual ~Raven_Bot();
  ...
  //-------------------------------------------------------------------------
  bool          canStepLeftOf(Vector2D& PositionOfStep)const;
  bool          canStepRightOf(Vector2D& PositionOfStep)const;
  //-------------------------------------------------------------------------
  ...
  //-----------------
  double const							GetSkill(){ return m_dSkillLevel; }
  //-----------------
