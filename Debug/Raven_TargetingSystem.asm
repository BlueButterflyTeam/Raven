; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	E:\Documents\Cours\TP3\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?AddAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z ; Raven_TargetingSystem::AddAggresor
PUBLIC	?RemoveAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z ; Raven_TargetingSystem::RemoveAggresor
PUBLIC	?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z ; Raven_TargetingSystem::isAggressor
...
xdata$x	ENDS
xdata$x	SEGMENT
__unwindtable$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z$1
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z$1
	DD	02H
	DD	FLAT:__unwindfunclet$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z$2
__ehfuncinfo$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z DD 019930522H
	DD	04H
	DD	FLAT:__unwindtable$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
_TEXT	SEGMENT
tv138 = -84						; size = 4
tv70 = -80						; size = 4
tv135 = -76						; size = 4
...
__$EHRec$ = -12						; size = 12
_bot$ = 8						; size = 4
?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z PROC ; Raven_TargetingSystem::isAggressor
; _this$ = ecx
...
; 80   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 81   : 	if (m_pAggresors.empty()){ return false; }
	...
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN5@isAggresso
	xor	al, al
	jmp	$LN6@isAggresso
$LN5@isAggresso:

; 82   : 
; 83   : 	std::list<Raven_Bot*>::const_iterator curBot = m_pAggresors.begin();
	...
	lea	ecx, DWORD PTR $T6[ebp]
	call	??1?$_List_iterator@V?$_List_val@U?$_List_simple_types@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	jmp	SHORT $LN4@isAggresso
$LN3@isAggresso:

; 84   : 	for (curBot; curBot != m_pAggresors.end(); ++curBot)
...
$LN4@isAggresso:
	...
	test	ecx, ecx
	je	SHORT $LN2@isAggresso

; 85   : 	{
; 86   : 		if ((*curBot) == bot){ return true; }

	lea	ecx, DWORD PTR _curBot$[ebp]
	call	??D?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@PAVRaven_Bot@@@std@@@std@@@std@@QBEABQAVRaven_Bot@@XZ ; std::_List_const_iterator<std::_List_val<std::_List_simple_types<Raven_Bot *> > >::operator*
	mov	edx, DWORD PTR [eax]
	cmp	edx, DWORD PTR _bot$[ebp]
	jne	SHORT $LN1@isAggresso
	mov	BYTE PTR $T3[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curBot$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T3[ebp]
	jmp	SHORT $LN6@isAggresso
$LN1@isAggresso:

; 87   : 	}

	jmp	SHORT $LN3@isAggresso
$LN2@isAggresso:
...
; 90   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN14@isAggresso
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z$0:
	lea	ecx, DWORD PTR $T6[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@U?$_List_simple_types@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z$1:
	lea	ecx, DWORD PTR _curBot$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z$2:
	lea	ecx, DWORD PTR $T4[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@U?$_List_simple_types@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__ehhandler$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-80]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z ENDP ; Raven_TargetingSystem::isAggressor
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\raven_targetingsystem.h
;	COMDAT ?RemoveAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_aggressor$ = 8						; size = 4
?RemoveAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z PROC ; Raven_TargetingSystem::RemoveAggresor, COMDAT
; _this$ = ecx

; 76   :   void		 RemoveAggresor(Raven_Bot* aggressor){ if (isAggressor(aggressor)){ m_pAggresors.remove(aggressor); } }
	...
	mov	DWORD PTR [ebp-4], -858993460		; ccccccccH
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _aggressor$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?isAggressor@Raven_TargetingSystem@@QAE_NPAVRaven_Bot@@@Z ; Raven_TargetingSystem::isAggressor
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN2@RemoveAggr
	lea	edx, DWORD PTR _aggressor$[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
...
$LN2@RemoveAggr:
	...
	pop	ebp
	ret	4
?RemoveAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z ENDP ; Raven_TargetingSystem::RemoveAggresor
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\raven_targetingsystem.h
;	COMDAT ?AddAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_aggressor$ = 8						; size = 4
?AddAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z PROC ; Raven_TargetingSystem::AddAggresor, COMDAT
; _this$ = ecx

; 73   :   void		 AddAggresor(Raven_Bot* aggressor){ m_pAggresors.push_back(aggressor);}
	...
	mov	DWORD PTR [ebp-4], -858993460		; ccccccccH
	mov	DWORD PTR _this$[ebp], ecx
	lea	eax, DWORD PTR _aggressor$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	...
	pop	ebp
	ret	4
?AddAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z ENDP ; Raven_TargetingSystem::AddAggresor
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
_TEXT	SEGMENT
...
; 76   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenOutOfView(m_pCurrentTarget);
...
; 71   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenVisible(m_pCurrentTarget);
...
; 66   :   return m_pOwner->GetSensoryMem()->GetLastRecordedPositionOfOpponent(m_pCurrentTarget);
...
; 61   :   return m_pOwner->GetSensoryMem()->isOpponentShootable(m_pCurrentTarget);
...
; 56   :   return m_pOwner->GetSensoryMem()->isOpponentWithinFOV(m_pCurrentTarget);
...
; 20   :   if (m_pCurrentTarget != NULL){

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN7@Update

; 21   :     m_pCurrentTarget->GetTargetSys()->RemoveAggresor(m_pOwner);
	...
	mov	ecx, eax
	call	?RemoveAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z ; Raven_TargetingSystem::RemoveAggresor
$LN7@Update:
...
; 46   :   if (m_pCurrentTarget != NULL && isTargetShootable()){
...
; 47   : 	m_pCurrentTarget->GetTargetSys()->AddAggresor(m_pOwner);
	...
	call	?GetTargetSys@Raven_Bot@@QAEQAVRaven_TargetingSystem@@XZ ; Raven_Bot::GetTargetSys
	mov	ecx, eax
	call	?AddAggresor@Raven_TargetingSystem@@QAEXPAVRaven_Bot@@@Z ; Raven_TargetingSystem::AddAggresor
$LN1@Update:
