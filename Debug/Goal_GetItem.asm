; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	E:\Documents\Cours\TP3\Buckland_Chapter7 to 10_Raven\goals\Goal_GetItem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG157662 DB	'Goal_GetItem cannot determine item type', 00H
CONST	ENDS
PUBLIC	_hypot
...
EXTRN	??0Goal_FollowPath_Dodge@@QAE@PAVRaven_Bot@@V?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@Z:PROC ; Goal_FollowPath_Dodge::Goal_FollowPath_Dodge
...
__unwindtable$?Activate@Goal_GetItem@@UAEXXZ DD 0ffffffffH
	...
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_GetItem@@UAEXXZ$1
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\common\triggers\trigger.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\goals\goal_dodgesidetoside.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\goals\goal_wander.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\goals\goal_getitem.cpp
_TEXT	SEGMENT
tv157 = -72						; size = 4
tv171 = -68						; size = 4
tv170 = -64						; size = 4
...
; 88   :   //first, pass the message down the goal hierarchy
; 89   :   bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 92   : 
; 93   :   //if the msg was not handled, test to see if this goal can handle it
; 94   :   if (bHandled == false)
...
; 97   :     {
; 98   :     case Msg_PathReady:
; 99   : 
; 100  :       //clear any existing goals
; 101  :       RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 102  : 
; 103  :       AddSubgoal(new Goal_FollowPath_Dodge(m_pOwner,
; 104  :                                      m_pOwner->GetPathPlanner()->GetPath()));
	...
	call	??0Goal_FollowPath_Dodge@@QAE@PAVRaven_Bot@@V?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@Z ; Goal_FollowPath_Dodge::Goal_FollowPath_Dodge
...
; 106  : 	  /*
; 107  : 	  //------------------------------
; 108  : 	  //add dodging while getting item
; 109  : 	  if (m_pOwner->canStepLeft(dummy) || m_pOwner->canStepRight(dummy)){
; 110  : 		  AddSubgoal(new Goal_DodgeSideToSide(m_pOwner));
; 111  : 	  }
; 112  : 	  //------------------------------
; 113  : 	*/
; 114  : 
; 115  :       //get the pointer to the item
; 116  :       m_pGiverTrigger = static_cast<Raven_Map::TriggerType*>(msg.ExtraInfo);
...
; 77   :   {
; 78   :     //process the subgoals
; 79   :     m_iStatus = ProcessSubgoals();
...
; 55   : 
; 56   :   
; 57   :   //add dodging while getting item
; 58   :   Vector2D dummy;

	lea	ecx, DWORD PTR _dummy$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 59   :   if (m_pOwner->canStepLeft(dummy) || m_pOwner->canStepRight(dummy)){
...
; 60   : 	  AddSubgoal(new Goal_DodgeSideToSide(m_pOwner));
...
; 63   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN14@Activate
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
__unwindfunclet$?Activate@Goal_GetItem@@UAEXXZ$0:
	...
	pop	ecx
	ret	0
__unwindfunclet$?Activate@Goal_GetItem@@UAEXXZ$1:
	mov	eax, DWORD PTR $T2[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
...
; 142  :   if (m_pGiverTrigger &&
; 143  :       !m_pGiverTrigger->isActive() &&
; 144  :       m_pOwner->hasLOSto(m_pGiverTrigger->Pos()) )
