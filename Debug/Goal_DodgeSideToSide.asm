; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	E:\Documents\Cours\TP3\Buckland_Chapter7 to 10_Raven\goals\Goal_DodgeSideToSide.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?isAggressed@Raven_TargetingSystem@@QAE_NXZ	; Raven_TargetingSystem::isAggressed
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\raven_steeringbehaviors.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\goals\goal_dodgesidetoside.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 82   :   m_pOwner->GetSteering()->SeekOff();
...
; 89   : #define SHOW_TARGET
; 90   : #ifdef SHOW_TARGET
; 91   :   gdi->OrangePen();
...
; 93   : 
; 94   :   gdi->Line(m_pOwner->Pos(), m_vStrafeTarget);
...
; 95   :   gdi->Circle(m_vStrafeTarget, 3);
...
; 59   :   //if status is inactive, call Activate()
...
; 61   : 
; 62   :   //if target goes out of view or owner isn't aggressed terminate
; 63   :   if (!m_pOwner->GetTargetSys()->isTargetWithinFOV() || !m_pOwner->GetTargetSys()->isAggressed())
	...
	call	?GetTargetSys@Raven_Bot@@QAEQAVRaven_TargetingSystem@@XZ ; Raven_Bot::GetTargetSys
	mov	ecx, eax
	call	?isAggressed@Raven_TargetingSystem@@QAE_NXZ ; Raven_TargetingSystem::isAggressed
	movzx	eax, al
	test	eax, eax
...
; 66   :   }
; 67   : 
; 68   :   //else if bot reaches the target position set status to inactive so the goal 
; 69   :   //is reactivated on the next update-step
; 70   :   else if (m_pOwner->isAtPosition(m_vStrafeTarget))
...
;	COMDAT ?isAggressed@Raven_TargetingSystem@@QAE_NXZ
_TEXT	SEGMENT
tv69 = -8						; size = 4
_this$ = -4						; size = 4
?isAggressed@Raven_TargetingSystem@@QAE_NXZ PROC	; Raven_TargetingSystem::isAggressed, COMDAT
; _this$ = ecx

; 82   :   bool		 isAggressed(){ return !m_pAggresors.empty(); }
	...
	movzx	eax, al
	test	eax, eax
	jne	SHORT $LN3@isAggresse
	mov	DWORD PTR tv69[ebp], 1
	jmp	SHORT $LN4@isAggresse
$LN3@isAggresse:
...
$LN4@isAggresse:
	...
	pop	ebp
	ret	0
?isAggressed@Raven_TargetingSystem@@QAE_NXZ ENDP	; Raven_TargetingSystem::isAggressed
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
