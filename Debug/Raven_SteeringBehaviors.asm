; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	E:\Documents\Cours\TP3\Buckland_Chapter7 to 10_Raven\Raven_SteeringBehaviors.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG156852 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG156853 DB	'SeparationWeight', 00H
	ORG $+3
$SG156854 DB	'WanderWeight', 00H
	ORG $+3
$SG156855 DB	'WallAvoidanceWeight', 00H
$SG156856 DB	'SeekWeight', 00H
	ORG $+1
$SG156857 DB	'ArriveWeight', 00H
	ORG $+3
$SG156858 DB	'ViewDistance', 00H
	ORG $+7
...
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\common\game\entityfunctiontemplates.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\documents\cours\tp3\buckland_chapter7 to 10_raven\raven_steeringbehaviors.cpp
_TEXT	SEGMENT
$T1 = -20						; size = 16
_this$ = -4						; size = 4
...
; 47   : {
	...
	push	OFFSET $SG156853
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+120]
	push	OFFSET $SG156854
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+128]
	push	OFFSET $SG156855
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [ecx+136]
	push	OFFSET $SG156856
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+144]
	push	OFFSET $SG156857
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+152]
	push	OFFSET $SG156858
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
